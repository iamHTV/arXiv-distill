# Skill: Opir — Efficient Multi-Task Safety Classification
Source: 2605.29659
Type: workflow

## When to use this skill
- When deploying LLM applications needing real-time safety filtering
- When needing to classify toxicity, jailbreak, hate speech
- When needing edge deployment with low latency

## When NOT to use
- Non-LLM applications
- High-impact decisions (legal, employment, credit) — need human review
- Encoder architecture not available

## Required inputs
- LLM prompts and responses to classify
- Safety taxonomy (996 categories optional)
- Opir model (multi-task or edge variant)

## Steps

### Step 1 — Choose Model Variant
...
## Example application
**Scenario**: Deploy LLM chatbot for customer service. Need safety filtering.
